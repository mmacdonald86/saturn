...
double ctrModel::get_prob(std::vector<std::string> input)
{
    ...
    _feature_engine.update_field(FeatureEngine::StringField::ctr_publisher_id, input[3]);
    _feature_engine.update_field(FeatureEngine::StringField::ctr_traffic_name, input[4]);
    _feature_engine.update_field(FeatureEngine::StringField::ctr_age, input[5]);
    ...
    _feature_engine.update_field(FeatureEngine::StringField::ctr_creative_type, input[12]);
    _feature_engine.update_field(FeatureEngine::StringField::ctr_adomain, input[13]);
    ...
    _feature_engine.update_field(FeatureEngine::StringField::ctr_sic, input[20]);
